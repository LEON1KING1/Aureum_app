...
# Bot configuration
# ----------------------------
# Token provided explicitly (you can override with env var)
TOKEN = os.getenv("BOT_TOKEN") or "8347270277:AAEVAsSjrAZeIGe7v5mUOVhLV3oPmTD8QGM"

# If running on Replit, set REPLIT_WEB_URL env var to your Replit URL (e.g. https://your-repl.username.repl.co)
WEBAPP_URL = os.getenv("REPLIT_WEB_URL") or os.getenv("WEBAPP_URL") or "https://leon1king1.github.io/Aureum_app/index.html"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    username, rec = ensure_user_by_tg(user)
    ...
    # first-time signup bonus if balance zero
...
async def leaderboard_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    arr = []
    for uname, r in db.items():
        arr.append((uname, r.get("balance",0)))
...
# handle incoming messages including web_app_data
...
def main():
    if not TOKEN:
        print("ERROR: Bot token not set. Set BOT_TOKEN env var or edit the file.")
        return
